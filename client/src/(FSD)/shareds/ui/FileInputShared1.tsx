...
const FileInputShared1 = ({ inputId, setFile, height = 160, image}: FileInputSharedProps) => {
        ...
        <div style={{ height: height }} className={`${preview ? "" : "bg-content2"} rounded-medium ${styles.file_container}`}>
            ...
            }
            {
                ...
                <div className={styles.preview_img_box}>
                    ...
                    <Image src={`data:image/jpeg;base64,${image}`} alt={"preview"} layout="fill" objectFit="contain" />
                </div>
            }
        </div>
    );
